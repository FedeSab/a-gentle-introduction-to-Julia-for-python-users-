...
COLUMNS_TO_DROP = ["COMMONAREA_MEDI","NONLIVINGAPARTMENTS_AVG","NONLIVINGAPARTMENTS_MEDI",
                    "LIVINGAPARTMENTS_MEDI","LIVINGAPARTMENTS_AVG","SK_ID_CURR","FLAG_MOBIL",
...
COLUMNS_NUM = ['Unnamed: 0', 'CNT_CHILDREN', 'AMT_INCOME_TOTAL', 'AMT_CREDIT', 'AMT_ANNUITY', 
                ...
                'YEARS_BUILD_AVG', 'APARTMENTS_MODE', 'BASEMENTAREA_MODE', 
